...
module.exports = function () {
    ...
    QUnit.test( 'Quat.init', function () {
        var q = Quat.create();
        Quat.init( q );
        deepEqual( q, Quat.createAndSet( 0.0, 0.0, 0.0, 1.0 ) );
    } );

    QUnit.test( 'Quat.makeRotate', function () {
        var q0 = Quat.makeRotate( Math.PI, 1.0, 0.0, 0.0, Quat.create() );
        mockup.near( q0, Quat.createAndSet( 1.0, 0.0, 0.0, 6.12303e-17 ), 1e-5 );

        var q1 = Quat.makeRotate( Math.PI / 2, 0.0, 1.0, 0.0, Quat.create() );
        mockup.near( q1, Quat.createAndSet( 0.0, 0.707107, 0.0, 0.707107 ) );

        var q2 = Quat.makeRotate( Math.PI / 4, 0.0, 0.0, 1.0, Quat.create() );
        mockup.near( q2, Quat.createAndSet( 0.0, 0.0, 0.382683, 0.92388 ) );
    } );
    ...
    QUnit.test( 'Quat.makeRotateFromTo', function () {
        ...
        mockup.near( q1, Quat.createAndSet( 0.0, 0.0, 0.707107, 0.707107 ), 1e-5 );
    ...
    QUnit.test( 'Quat.mult', function () {
        ...
        mockup.near( Quat.mult( q2, Quat.mult( q1, q0, Quat.create() ), Quat.create() ), Quat.createAndSet( 0.653281, 0.270598, -0.653281, 0.270598 ) );
    } );
    ...
    QUnit.test( 'Quat.slerp', function () {
        ...
        mockup.near( res, Quat.createAndSet( 0.0, 0.388863, 0.210451, 0.896937 ) );
    ...
    QUnit.test( 'Quat.transformVec3', function () {
        ...
        mockup.near( v, Vec3.createAndSet( 3.0, 2.0, -1.0 ) );
    } );
