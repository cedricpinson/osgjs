define( [
    ...
    return function () {
        ...
        test( 'TextureManager flushDeletedTextureObjects', function() {
            ...
            tm.flushDeletedTextureObjects( gl , 0.001 );
            // There is no time to flush all the released texture objects
            ok( tm._textureSetMap[ '3553640810241024' ].getOrphanedTextureObjects().length > 0, 'check orphan 1024x1024 empty delete' );
            // flush TO's in 5 seconds 
            tm.flushDeletedTextureObjects( gl , 5.0 );
