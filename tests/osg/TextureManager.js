...
export default function() {
    test('TextureManager', function() {
        ...
        assert.equal(
            tm._textureSetMap['3553640810241024'].getUsedTextureObjects().length,
            4,
            'check nb texture 1024x1024 created'
        );
        assert.equal(
            tm._textureSetMap['355364065121024'].getUsedTextureObjects().length,
            2,
            'check nb texture 512x1024 created'
        );

        assert.equal(
            tm._textureSetMap['3553640810241024'].getOrphanedTextureObjects().length,
            0,
            'check orphan texture 1024x1024 null'
        );
        assert.equal(
            tm._textureSetMap['355364065121024'].getOrphanedTextureObjects().length,
            0,
        ...
        assert.equal(
            tm._textureSetMap['3553640810241024'].getOrphanedTextureObjects().length,
            4,
            'check orphan 1024x1024 after release'
        );
        assert.equal(
            tm._textureSetMap['355364065121024'].getOrphanedTextureObjects().length,
            2,
            'check orphan 512x1024 after release'
        );

        assert.equal(
            tm._textureSetMap['3553640810241024'].getUsedTextureObjects().length,
            0,
            'check used 1024x1024 empty after release'
        );
        assert.equal(
            tm._textureSetMap['355364065121024'].getUsedTextureObjects().length,
            0,
            'check used 512x1024 empty after release'
        );
        ...
        assert.equal(
            tm._textureSetMap['355364065121024'].getOrphanedTextureObjects().length,
            0,
            'check orphan 512x1024 empty after delete'
        );
    });
    ...
    test('TextureManager flushDeletedTextureObjects', function() {
        ...
        assert.isOk(
            tm._textureSetMap['3553640810241024'].getOrphanedTextureObjects().length > 0,
            'check orphan 1024x1024 delete not empty'
        );
        // flush all TO's
        tm.flushAllDeletedTextureObjects(gl);
