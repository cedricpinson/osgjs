...
export default function() {
    test('FrameBufferObject', function() {
        ...
        (function() {
            ...
            b.apply(state);
            assert.isOk(
                b.getFrameBufferObject() === undefined,
                'Check we did not created gl framebuffer'
            );
        })();
        ...
        (function() {
            ...
            var renderBuffer = fbo.createRenderBuffer(
            ...
            assert.isOk(
                fbo.isDirty() === false,
                'Check that applied set dirty false even with no attachement'
            );
