...
define( [
    ...
    PolytopeIntersector.prototype = {
        ...
        {
            // Note: las polytope value depends on the Coordinate frame
            ...
            this.setPolytope( [ [ 1.0, 0.0, 0.0, -xMin ] , [ -1.0, 0.0, 0.0, xMax ] , [ 0.0, 1.0, 0.0, -yMin ] , [ 0.0, -1.0, 0.0, yMax ] , [ 0.0, 0.0, 1.0, 0.0 ] ] );
        },
