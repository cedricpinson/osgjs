...
Input.prototype = {
    ...
    _DDSParse: function (buffer, loadMipmaps) {
        ...
        if (header[off_magic] !== DDS_MAGIC) {
            ...
            notify.error('  _DDSParse:Invalid magic number in DDS header.');
            return dds;
        ...
        if (!header[off_pfFlags] & DDPF_FOURCC) {
            ...
            notify.error('  _DDSParse:Unsupported format, must contain a FourCC code.');
            return dds;
        ...
        switch (fourCC) {
            ...
            default:
                ...
                if (header[off_RGBBitCount] === 32
                    ...
                    notify.error(' _DDSParse:Unsupported FourCC code ', int32ToFourCC(fourCC));
        ...
        if (dds.isCubemap && (
            ...
            notify.error(' _DDSParse:Incomplete cubemap faces');
    ...
    readImageURL: function(url, options) {
        ...
        if (url.indexOf('.dds') !== -1) {
            ...
            ddsXhr.onload = function () {
                var texDatas = that._DDSParse(this.response, true);
                image.setURL = url;
