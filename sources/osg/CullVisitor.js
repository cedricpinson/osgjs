define( [
    ...
    'osg/Camera',
    'osg/TransformEnums'
], function ( Notify, MACROUTILS, NodeVisitor, CullSettings, CullStack, Matrix, MatrixTransform, Projection, LightSource, Geometry, RenderLeaf, RenderStage, Node, Lod, PagedLOD, Camera, TransformEnums ) {
    'use strict';
    ...
    CullVisitor.prototype[ Camera.typeID ] = function ( camera ) {
        ...
        // global override
        if ( previousCullsettings.getSettingSource() === this && previousCullsettings.getEnableFrustumCulling() ) {
