...
MACROUTILS.createPrototypeObject(
    Normalize,
    MACROUTILS.objectInherit(NodeFunctions.prototype, {
        type: 'Normalize',
        validInputs: ['vec'],
        validOuputs: ['vec'],
...
MACROUTILS.createPrototypeObject(
    ...
    MACROUTILS.objectInherit(NodeFunctions.prototype, {
        ...
        computeConversion: function(funcName) {
            ...
            return utils.callFunction(funcName, out.getVariable() + rgb, [
                color.getVariable() + rgb
            ]);
        }
    }),
    'osgShader',
...
MACROUTILS.createPrototypeObject(
    LinearTosRGB,
    MACROUTILS.objectInherit(sRGBToLinear.prototype, {
        type: 'LinearTosRGB',
        computeShader: function() {
...
MACROUTILS.createPrototypeObject(
    ...
    MACROUTILS.objectInherit(NodeFunctions.prototype, {
        ...
        validOutputs: ['color'],
        computeShader: function() {
            return utils.callFunction('encodeRGBM', this._outputs.color, [
                getVec3(this._inputs.color),
                this._inputs.range
            ]);
        }
    }),
...
MACROUTILS.createPrototypeObject(
    ...
    MACROUTILS.objectInherit(NodeFunctions.prototype, {
        ...
        validOutputs: ['color'],
        computeShader: function() {
            return utils.callFunction('decodeRGBM', this._outputs.color, [
                this._inputs.color,
                this._inputs.range
            ]);
        }
