...
MACROUTILS.createPrototypeObject(
    ...
    MACROUTILS.objectInherit(Node.prototype, {
        ...
        globalFunctionDeclaration: function() {
            ...
            ////// Signature
            var str =
                'vec3 morphTransform( const in vec4 weights,  const in vec3 vertex, const in vec3 target0';
            for (i = 1; i < nbTargets; ++i) str += ', const in vec3 target' + i;
            str += ' ) { \n';
            ...
            if (nbTargets === 1) {
                ...
                for (i = 1; i < nbTargets; ++i) str += ' + weights[' + i + ']';
                str += '));\n';
