...
MACROUTILS.createPrototypeObject(
    ...
    MACROUTILS.objectInherit(Node.prototype, {
        ...
        computeShader: function() {
            return utils.callFunction(this.functionName, this._outputs.color, [
...
MACROUTILS.createPrototypeObject(
    TextureRGB,
    MACROUTILS.objectInherit(NodeTextures.prototype, {
        type: 'TextureRGB',
...
MACROUTILS.createPrototypeObject(
    TextureRGBA,
    MACROUTILS.objectInherit(TextureRGB.prototype, {
        type: 'TextureRGBA',
