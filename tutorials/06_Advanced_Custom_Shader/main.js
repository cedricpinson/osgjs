...
function createScene() {
    ...
    target.getOrCreateStateSet().setAttributeAndMode(getShader());
    target2.getOrCreateStateSet().setAttributeAndMode(getShaderVariant2());
    //quad.getOrCreateStateSet().addUniform();
    ...
    root.getOrCreateStateSet().setAttributeAndMode(new osg.CullFace('DISABLE'));
