...
function createScene() {
  ...
  lightNode.getOrCreateStateSet().setAttribute(material);
	lightNode.getOrCreateStateSet().setAttributeAndMode(new osg.CullFace('BACK'));
    ...
    targetNode.getOrCreateStateSet().setAttributeAndMode(getShader());
  ...
  var lightVertsArr = lightModel.getAttributes().Vertex.getElements();   
	lightVerts = osg.Uniform.createFloat3(lightVertsArr, 'lightverts') ; 
