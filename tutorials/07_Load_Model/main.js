var main = function () {
  ...
  rootModelNode.setMatrix(osg.Matrix.makeRotate(-Math.PI / 2, 1, 0, 0, []));
    ...
    var url_model;
    switch(modelName){
      case "mickey": url_model = 'http://osgjs.org/examples/pointcloud/' +  modelName + '.osgjs';break;
      case "pokerscene": url_model = 'http://osgjs.org/examples/pokerscene/' +  modelName + '.js';break;
      case "ogre": url_model = 'http://osgjs.org/examples/shadow/' +  modelName + '.osgjs';break;
    }
        ...
        s.onload = function() {
          var NodeModel;
          switch(modelName){
            case "mickey": NodeModel = getModel();break;
            case "pokerscene": NodeModel = getPokerScene();break;
            case "ogre": NodeModel = getOgre();break;
          }
