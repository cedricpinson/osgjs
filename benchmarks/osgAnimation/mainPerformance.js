    ...
    QUnit.test('BasicAnimationManager Performance', function() {
        ...
        for (var n = 0; n < nCount; n++)
            for (var t = 0.0; t < 5.0; t += 0.016) {
                ...
                for (
                    var k = 0, l = basicAnimationManager._animationsUpdateCallbackArray.length;
                    k < l;
                    k++
                )
                    fakeResult +=
                        basicAnimationManager._animationsUpdateCallbackArray[k]._matrix[0];
            }
