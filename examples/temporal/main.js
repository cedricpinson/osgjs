(function() {
    ...
    var Example = function() {
        ...
        this._shaderNames = ['supersample.glsl', 'passthrough.glsl'];
    ...
    Example.prototype = osg.objectInherit(ExampleOSGJS.prototype, {
        createScene: function() {
            ...
            osgDB
                .readImageURL(this._mediaPath + 'textures/seamless/bricks1.jpg')
                .then(function(image) {
            ...
            var theGrid = osg.createGridGeometry(
                -1.0,
                -1.0,
                0.0,
                2.0,
        ...
        createComposer: function(sceneRTT) {
            ...
            // current Destination
            var rttAA0 = this.createTextureRTT(
                'antiAlias1',
                this._filterCheck,
            ...
            var rttAA1 = this.createTextureRTT(
                'antialias2',
                this._filterCheck,
                osg.Texture.UNSIGNED_BYTE
            );
            ...
            ///
            this._aaFilter = new osgUtil.Composer.Filter.PingPong(
                cameraRttAA0,
                rttAA0,
                cameraRttAA1,
                rttAA1,
            ...
            var passThroughFilter = new osgUtil.Composer.Filter.Custom(
                fragmentShader,
                this._uniforms
            );
        ...
        run: function() {
            ...
            // rotating cube  scene
            this._rttScene = this.createTextureRTT(
                'sceneRTT',
                this._filterCheck,
                osg.Texture.UNSIGNED_BYTE
            );
            ...
            this._quad = osg.createTexturedQuadGeometry(
                -quadSize[0] / 2.0,
                0,
                -quadSize[1] / 2.0,
                quadSize[0],
