(function() {
    ...
    Example.prototype = {
        initGui: function() {
            ...
            var alignmentController = this.gui.add(
                this.params,
                'alignment',
            ...
            var characterSizeModeController = this.gui.add(
                this.params,
                'characterSizeMode',
        ...
        onMouseClick: function(canvas, viewer, ev) {
            ...
            var hits = this.viewer.computeIntersections(
                ev.clientX * ratioX,
        ...
        run: function() {
            ...
            canvas.addEventListener(
                'click',
                this.onMouseClick.bind(this, canvas, this.viewer),
                true
            );
        }
    };
