(function() {
    ...
    var items = [
        {
            img:
                'https://d35krx4ujqgbcr.cloudfront.net/urls/2bf733b0b4794f73a894a656b065b982/thumbnails/bf1796af633a47808ed0f1346d766f20/640.jpeg',
            uid: 'bf733b0b4794f73a894a656b065b982'
        },
        {
            img:
                'https://d35krx4ujqgbcr.cloudfront.net/urls/1d87504923ef44b9947b425395796ac6/thumbnails/4c7f1ce3391e4f7ca49c9e18d939b2cc/640.jpeg',
            uid: '1d87504923ef44b9947b425395796ac6'
        },
        {
            img:
                'https://d35krx4ujqgbcr.cloudfront.net/urls/c3effcd7efc8450995384cb9d6518575/thumbnails/6f9876a567c7408dbb3ecedf6c2e8ff0/640.jpeg',
            uid: 'c3effcd7efc8450995384cb9d6518575'
        },
        {
            img:
                'https://d35krx4ujqgbcr.cloudfront.net/urls/e7c7c7c5e8f74f54a0a35f54c6d6c1f2/thumbnails/381d64afc71e40e6b0f42e6c89593211/640.jpeg',
            uid: 'e7c7c7c5e8f74f54a0a35f54c6d6c1f2'
        },
        {
            img:
                'https://d35krx4ujqgbcr.cloudfront.net/urls/4ed168c8d59a4d1687ae743bd3fbdfee/thumbnails/0055d3318c774d49b5dbaebf1f7fc205/640.jpeg',
            uid: '4ed168c8d59a4d1687ae743bd3fbdfee'
        },
        {
            img:
                'https://d35krx4ujqgbcr.cloudfront.net/urls/992ad54c89a343d09fc9d977347fd3c3/thumbnails/e2f513bb5d674f4a9720bd0a28dff2b6/640.jpeg',
    ...
    Example.prototype = osg.objectInherit(ExampleOSGJS.prototype, {
        ...
        createCamera: function() {
            ...
            var geometry = osg.createTexturedQuadGeometry(
                -size / 2,
                -size / 2,
                0,
                size,
        ...
        enableVR: function(scene) {
            ...
            if (navigator.getVRDevices || navigator.mozGetVRDevices) {
                ...
                nodeVR = osgUtil.WebVR.createScene(
                    viewer,
                    scene,
                    viewer.getEventProxy().WebVR.getHmd()
                );
            } else {
        ...
        createScene: function() {
            ...
            for (var j = 0; j < row; j++) {
                for (i = 0, l = nb; i < l; i++) {
                    scene.addChild(
                        this.createTexturedQuad(
                            startIndex + i * (size + marge),
                            j * (sizey + marge * sizey),
                            size,
                            items[index]
                        )
