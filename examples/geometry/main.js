    ...
    Example.prototype = osg.objectInherit(ExampleOSGJS.prototype, {
        ...
        createPoints: function() {
            ...
            geom.setVertexAttribArray(
                'Color',
                new osg.BufferArray(osg.BufferArray.ARRAY_BUFFER, colors, 3)
            );
            geom.getPrimitiveSetList().length = 0;
            geom
                .getPrimitiveSetList()
                .push(new osg.DrawArrays(osg.primitiveSet.POINTS, 0, segment * segment * 4));
            var mt = new osg.MatrixTransform();
            mt.addChild(geom);
            mt.setMatrix(
                osg.mat4.fromTranslation(osg.mat4.create(), osg.vec3.fromValues(1.8, 0, 0.4))
            );
        ...
        createLines: function() {
            ...
            geom.setVertexAttribArray(
                'Vertex',
                new osg.BufferArray(osg.BufferArray.ARRAY_BUFFER, vertices, 3)
            );
            geom.setVertexAttribArray(
                'Normal',
                new osg.BufferArray(osg.BufferArray.ARRAY_BUFFER, normals, 3)
            );
            geom.setVertexAttribArray(
                'Color',
                new osg.BufferArray(osg.BufferArray.ARRAY_BUFFER, colors, 3)
        ...
        createTriangles: function() {
            ...
            geom
                .getPrimitiveSetList()
                .push(new osg.DrawArrays(osg.primitiveSet.TRIANGLE_STRIP, 6, 6));
            geom
                .getPrimitiveSetList()
                .push(new osg.DrawArrays(osg.primitiveSet.TRIANGLE_FAN, 12, 5));
            return geom;
        },
