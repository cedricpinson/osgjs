( function () {
    ...
    var MotionBlurEffect = {
        ...
        name: 'MotionBlur (Object/VelocityBuffer)',
        ...
        buildComposer: function ( helper ) {
            ...
            this._sceneTexture2.setMinFilter( 'LINEAR' );
            this._sceneTexture2.setMagFilter( 'LINEAR' );
            ...
            var MotionBlurFilter = new osgUtil.Composer.Filter.Custom(
                osgShader.ShaderProcessor.instance.getShader( 'shaders/motionBlurVelocity.glsl' ), {
