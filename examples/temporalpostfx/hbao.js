( function () {
    ...
    var HBAOEffect = {
        ...
        buildComposer: function ( helper ) {
            ...
            this._composer.addPass( HBAOReconstructionFilter, this._finalTexture );
            this._composer.build();


            this._nearFarUnif = HBAOReconstructionFilter._stateSet.getUniformList().NearFar.getUniform();
    ...
    window.postScenes.push( HBAOEffect );
} )();
