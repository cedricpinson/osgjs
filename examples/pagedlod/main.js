(function() {
    ...
    Example.prototype = {
        ...
        run: function() {
            ...
            var node = osg.createTexturedQuadGeometry(
                minExtent[0],
                minExtent[1],
                0,
            ...
            var create = function createPagedLODGroup(parent) {
                ...
                for (var i = 0; i < 4; i++) {
                    ...
                    var tileGeometry = that.levelRowColToXYWidthHeight(
                        0,
                        designation.sLevel,
                        designation.sRow,
                        designation.sCol
                    ...
                    var nodeTile = that.createTileForGeometry(
                        i,
                        tileGeometry.x,
                        tileGeometry.y,
                        tileGeometry.width,
            ...
            for (var i in this.gui.__controllers) this.gui.__controllers[i].updateDisplay();
            this.viewer.run();
        }
    };
